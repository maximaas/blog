...
2、把SD卡取出插入电脑，在sd2snes\cheats目录下新建一个文本文件，将其命名为“Final Fantasy VI (C).yml”，文件名与ROM文件名保持一致，接着用记事本编辑这个文件，把代码写进去：

![image](/blog/assets/images/posts/20170927/02.jpg)
...
![image](/blog/assets/images/posts/20170927/03.jpg)

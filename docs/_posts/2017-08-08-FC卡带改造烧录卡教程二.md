...
> Flash芯片的控制针脚通常是如下的对应关系：
> | Pin     | FC          | 说明                                                                  |
> |:--------|:------------|:----------------------------------------------------------------------|
> | WE＃    | CPU R/W     | 对应卡带金手指（Edge Connector）的14pin。                             |
> | OE＃    | PRG /CE     | PRG /CE通常在MMC芯片上。也存在很多例外，这时就需要利用74芯片来自制。  |
> | CE＃    | CPU /ROMCS  | 对应卡带金手指（Edge Connector）的44pin。                             |
> MMC1芯片是有PRG /CE针脚的。
...
#### ======== Updated on 2017-08-09 ========
> 
> 用于作为CHR的Flash芯片的控制针脚通常是如下的对应关系：
> | Pin     | FC          | 说明                                          |
> |:--------|:------------|:----------------------------------------------|
> | WE＃    | PPU /WR     | 对应卡带金手指（Edge Connector）的47pin。     |
> | OE＃    | PRG /RD     | 对应卡带金手指（Edge Connector）的17pin。     |
> | CE＃    | PPU A13     | 对应卡带金手指（Edge Connector）的56pin。     |
